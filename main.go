...
func run() error {
	...
	if err := drawTitle(r, "Floppy Gopher"); err != nil {
...
func drawTitle(r *sdl.Renderer, s string) error {
	r.Clear()
	...
	surface, err := font.RenderUTF8_Solid(s, sdl.Color{R: 255, G: 100, B: 0, A: 255})
	if err != nil {
